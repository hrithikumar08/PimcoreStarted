<?php
namespace Codilar\UserBundle\Model\Listing;

use Pimcore\Model\Listing\Dao\AbstractDao;
use Codilar\UserBundle\Model\SettingDetails;
use Doctrine\DBAL\Query\QueryBuilder as DoctrineQueryBuilder;
use Pimcore\Model\Listing\Dao\QueryBuilderHelperTrait;

class SettingListingDao extends AbstractDao
{
    ...
    public function load(): array
    {
        ...
        $objects = array();
        foreach ($list as $id) {
            if ($object = SettingDetails::getById($id)) {
                $objects[] = $object;
            }
        }

...
namespace Codilar\TrackingBundle\Model\Listing;
...
class Dao extends AbstractDao
{
    ...
    protected string $tableName = 'tracking_details';
    ...
    public function load(): array
    {
        ...
        $objects = array();
        foreach ($list as $id) {
            if ($object = TrackingDetails::getById($id)) {
                $objects[] = $object;
            }
        }
